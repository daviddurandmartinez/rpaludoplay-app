...
INPUT_MENU_PERSONAS_NUEVO_REGISTRO = (By.ID, "id_code")
...
INPUT_MENU_PERSONAS_LISTA_DOCUMENTO = (By.ID, "id_id_card")
XPATH_MENU_PERSONAS_LISTA_SELECCIONAR = "/html/body/section/div[2]/div[2]/div/div/a/div[6]"
XPATH_MENU_PERSONAS_LISTA_ACTUALIZAR = "/html/body/section/div[1]/a[3]"
CHECK_MENU_PERSONAS_LISTA_ACTIVAR_DESACTIVAR = (By.ID, "id_is_active")
XPATH_MENU_PERSONAS_LISTA_BOTON = "/html/body/section/div[2]/form/div[2]/div/button"